...
EXPORTS='["_w_set_sid_mode","_w_julday","_w_lon","_w_speed","_w_ayanamsa","_w_lagna","_w_rise","_w_equ","_w_ecl_lon","_w_pheno","_w_sidtime","_w_set_topo","_w_helio","_w_ecl_tret","_w_ecl_attr","_w_lun_ecl_how","_w_lun_ecl_when","_w_lun_ecl_when_loc","_w_sol_ecl_how","_w_sol_ecl_when_loc","_w_sol_ecl_when_glob","_w_sol_ecl_where","_malloc","_free"]'
